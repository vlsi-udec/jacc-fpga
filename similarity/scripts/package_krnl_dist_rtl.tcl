...
set reg      [::ipx::add_register -quiet "read_ptr_0" $addr_block]
  set_property address_offset 0x010 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg]
  set_property value m_axi_gmem_0 $regparam

set reg      [::ipx::add_register -quiet "read_offset_0" $addr_block]
...
set reg      [::ipx::add_register -quiet "pivot_ptr" $addr_block]
  set_property address_offset 0x02C $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg]
  set_property value m_axi_gmem_1 $regparam

set reg      [::ipx::add_register -quiet "pivot_offset" $addr_block]
  set_property address_offset 0x038 $reg
  set_property size           [expr {4*8}]   $reg

set reg      [::ipx::add_register -quiet "pivot_len" $addr_block]
  set_property address_offset 0x040 $reg
  set_property size           [expr {4*8}]   $reg

set reg      [::ipx::add_register -quiet "write_ptr" $addr_block]
  set_property address_offset 0x048 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg]
  set_property value m_axi_gmem_2 $regparam

set reg      [::ipx::add_register -quiet "write_len" $addr_block]
